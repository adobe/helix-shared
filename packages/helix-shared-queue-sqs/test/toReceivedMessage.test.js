...
describe('toReceivedMessage', () => {
  it('maps a full raw ReceiveMessageCommand-shaped message', () => {
    const raw = {
      MessageId: 'mid-1',
      Body: 'hello',
  ...
  it('leaves id/groupId/receiveCount undefined when the raw message has no Attributes', () => {
  ...
  it('does not mutate raw or detect a swap pointer -- that is SqsBackend-only behavior', () => {
