...
const implements = curry('implements', (Typ, trait) => Boolean(trait.lookupType(Typ)));

/** Test if the given trait has been implemented for the given value */
const valueImplements = curry('valueImplements', (val, trait) => Boolean(trait.lookupValue(val)));

// IMMUTABLE TRAIT ////////////////////////////////////

/** Test whether instance of a given type is immutable */
const typeIsImmutable = t => implements(t, Immutable);

/** Test whether a given value is immutable */
const isImmutable = v => valueImplements(v, Immutable);
